...
Comment.create(user_id: user4.id, product_id: p13.id, text: "I like ninjas. They rule.")
Comment.create(user_id: user1.id, product_id: p13.id, text: "Hmm.. we'll have to decide whether to take this down.")
...
Follow.create(follower_id: user5.id, followed_id: user4.id)
